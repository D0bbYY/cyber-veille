...
def scrape_splunk(url: str) -> list:
    """Scrape la page auteur Splunk — pattern flexible (tolère badges/spans dans le h3)."""
    try:
        ...
        # Pattern 2 : fallback — tout <a> blog avec texte >15 chars (attrape les articles héros)
